...
parser.add_argument('--scannet_path', default= '/vepfs/home/wangzhaoqing/runnan/datasets/scannet/scans/scans',
                    help='path to scannet data')
parser.add_argument('--label_map_file', default= '/vepfs/home/wangzhaoqing/runnan/datasets/scannet/scans/scannetv2-labels.combined.tsv',
...
def collect_point_data(scene_name):
    ...
    print(points.shape, instance_ids.shape, labels.shape)
