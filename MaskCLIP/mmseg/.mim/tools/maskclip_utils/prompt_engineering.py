...
scannet_classes = ['wall', 'floor', 'cabinet', 'bed', 'chair', 'sofa',
...
def parse_args():
    ...
    parser.add_argument('--class-set', default=['voc'], nargs='+',
        choices=['scannet', 'city', 'ade', 'stuff', 'voc', 'context', 'acontext', 'mickey', 'batman', 'mario', 'gates', 'blur', 'sports', 'car_brands', 'batman_ext', 'car_color'],
