...
class fusionNet(nn.Module):
    ...
    def forward(self, feature_packages, text_embeddings):
        ...
        # use the dynamic text_embeddings instead of fixed predefined ones
        text_embedding = text_embeddings[pixel_pred].unsqueeze(1)
