...
class MaskClipHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 text_embeddings_all_path='/mnt/lustre/chenrunnan/projects/MaskCLIP/pretrain/nuscenes_ViT16_clip_text.pth',
        ...
        self.text_embeddings_all_path = text_embeddings_all_path
        ...
        if self.text_embeddings_path is None:
            ...
            self.text_embeddings_all = nn.Parameter(torch.zeros(85, text_categories, text_channels))
            ...
            self.register_buffer('text_embeddings_all', torch.randn(85, text_categories, text_channels))
    ...
    def load_text_embeddings(self):
        ...
        loaded = torch.load(self.text_embeddings_all_path, map_location='cuda')
        self.text_embeddings_all[:, :, :] = loaded[:, :, :]
    ...
    def cls_seg(self, feat):
        ...
        num_ind = random.randint(10, 84)
        if self.text_augmentation and num_ind < 40:
            # import pdb
            # pdb.set_trace()
            random_index = random.sample(list(range(85)), num_ind)
            text_embeddings_random = self.text_embeddings_all[random_index]
            text_embeddings_random = text_embeddings_random.mean(dim=0)
            text_embeddings_random /= text_embeddings_random.norm()
            output = F.conv2d(feat, text_embeddings_random[:, :, None, None])
        else:
...
class maskClipFeatureExtractor(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder = MaskClipHead(text_embeddings_path=config['text_embeddings_path'],
                                    text_embeddings_all_path=config['text_embeddings_all_path'],
