...
from downstream.dataloader_scannetpp import make_data_loader as make_data_loader_scannetpp
...
def main():
    ...
    elif config["dataset"].lower() == "scannetpp":
        val_dataloader = make_data_loader_scannetpp(
            config, "val", num_threads=config["num_threads"]
        )
