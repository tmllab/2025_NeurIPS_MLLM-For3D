...
from downstream.dataloader_scannetpp import scannetpp_Dataset, scannetpp_collate_pair_fn
...
class DownstreamDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        elif self.config["dataset"].lower() == "scannetpp":
    ...
    def train_dataloader(self):
        ...
        if self.config["dataset"].lower() == "nuscenes":
            ...
            default_collate_pair_fn = scannetpp_collate_pair_fn
